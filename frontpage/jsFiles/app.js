...
const QA =mongoose.model("QADB",QASchema);

const q1 =new QA({
  ques:"Best season for planting rice?",
  ans:"Not Answered"
});
q1.save();
       ...
       else
       {
        ...
        x=Object.keys(docs).length;
         if(x==0)
          ...
          res.sendFile(str2 +"/views/dashboard.html");
         // console.log(str2 +"/views/dashboard.html");
       }
   });
...
app.post("/esignin.html",function(req,res)
{
  // const res2=req.body.s1;
   ...
   Taskse.find({username :v1, password: v2},function(err,docs)
   {
      ...
      //   x=Object.keys(docs).length;
      //    if(x==0)
      //    //res.sendFile("..\views\logine.html");
      //    else
      //    //res.sendFile(str2 +"/views/dashboard.html");
      //  }
   });
...
app.post("/gps.html",function(req,res)
{
    res.sendFile(str2+"/views/gps.html"); 
});
app.post("/psq.html",function(req,res)
{
    res.sendFile(str2+"/views/post.html"); 
});
app.post("/inp.html",function(req,res)
{
    const v1=req.body.str1;
    ...
    q1.save();
    res.send("Ques added suucessfully");
});
